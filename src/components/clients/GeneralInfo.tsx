    ...
    <>
      <section className="flex gap-x-3">
        <article className="border border-[#d3d3d3] flex-1 p-3 rounded-md">
          <div className="border-[#d3d3d3] rounded-xl border flex items-center justify-center w-16 h-12">
            <i className="fa fa-users text-black before:align-middle text-xl"></i>
          </div>
          <h3 className="text-gray-700 font-semibold text-xs">Total de clientes</h3>
        ...
        <article className="border border-[#d3d3d3] flex-1 p-3 rounded-md">
          ...
          <h3 className="text-gray-700 font-semibold text-xs">Clientes juridicos</h3>
        ...
        <article className="border border-[#d3d3d3] flex-1 p-3 rounded-md">
          ...
          <h3 className="text-gray-700 font-semibold text-xs">Clientes Naturales</h3>
