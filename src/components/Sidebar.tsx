...
export default function Sidebar() {
  return (
    <div className="h-screen bg-light-blue">
      <div className="flex px-4 items-center justify-start gap-x-4 py-4">
      ...
      <div className="p-4">
        <ul className="flex flex-col gap-y-2">
          <li>
            <Link href="/" className="bg-celeste/20 text-white w-full flex justify-start items-center gap-x-4 py-2 px-2 rounded-md border border-dark-blue/80 transition-transform hover:scale-95">
